			...
			<div className='md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16'>
				...
				<div>
					...
					<p className='text-base font-normal font-sans text-gray-400 mb-4'>
						...
						industry. I have a bachelor's degree in Foreign Language Studies.
						I'm passionate about creating beautiful and functional websites and
						web applications with JavaScript, React, and Node.js. I'm always
						looking for new challenges and opportunities to learn and grow as a
						developer. I work well as part of a team and I'm always looking for
						ways to improve my skills and knowledge. It's always exciting to use
						my skills and knowledge to create beautiful and functional websites
